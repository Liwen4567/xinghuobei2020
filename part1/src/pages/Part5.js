...
class Part5 extends Component {
    ...
    render() {
        return (
            <div id='part5'>
                <div className="part5-container" style={{ paddingTop: "10px" }}>
                    <div className="login-wrap">
                        <div className="login-html">
                            <input id="tab-1" type="radio" name="tab" className="sign-in" checked />
                            <label for="tab-1" className="tab" style={{ cursor: "pointer" }}>登录</label>
                            <input id="tab-2" type="radio" name="tab" class="sign-up"/>
                            <label for="tab-2" className="tab" style={{ cursor: "pointer" }}>注册</label>
                            <div className="login-form">
                                <form id="form1" action="" method="post">
                                    <div className="sign-in-htm">
                                        <div className="group">
                                            <label for="si_usermail" className="label">邮箱</label>
                                            <input id="si_usermail" type="text" className="input" placeholder="请输入邮箱" autocomplete="off" name="email" />
                                        </div>
                                        <div className="group">
                                            <label for="si_password" className="label">密码</label>
                                            <input id="si_password" type="password" className="input" data-type="password" placeholder="请输入密码" autocomplete="off" name="password" />
                                        </div>
                                        <div className="group">
                                            <input id="check" type="checkbox" className="check" />
                                            <label for="check"><span className="icon"></span> 记住密码</label>
                                        </div>
                                        <div className="group">
                                            <input type="button" className="button" id="button_si" value="登录" style={{ cursor: "pointer" }} onClick={this.signin.bind(this)} />
                                        </div>
                                ...
                                <form action="#" id="form2" method="post">
                                    <div className="sign-up-htm">
                                        <div className="group">
                                            <label for="su_username" className="label">用户名</label>
                                            <input id="su_username" type="text" className="input" placeholder="请输入至少1位的用户名" onBlur={this.checkUserName.bind(this)} oninput={this.checkUserName.bind(this)} autocomplete="off" name="username" />
                                            <span className="default" id="nameErr"></span>
                                        </div>
                                        <div class="group">
                                            <label for="su_password" className="label">密码</label>
                                            <input id="su_password" type="password" className="input" data-type="password" placeholder="请输入4到8位的密码" onBlur={this.checkPassword.bind(this)} oninput={this.checkPassword.bind(this)} autocomplete="off" name="password1" />
                                            <span className="default" id="passwordErr"></span>
                                        </div>
                                        <div className="group">
                                            <label for="su_password" className="label">确认密码</label>
                                            <input id="su_conpassword" type="password" className="input" data-type="password" placeholder="请再输入一遍密码" onBlur={this.ConfirmPassword.bind(this)} oninput={this.ConfirmPassword.bind(this)} autocomplete="off" name="password2" />
                                            <span className="default" id="conPasswordErr"></span>
                                        </div>
                                        <div className="group">
                                            <label for="su_usermail" className="label">邮箱</label>
                                            <input id="su_usermail" type="text" className="input" placeholder="请输入邮箱地址" onBlur={this.checkMail.bind(this)} oninput={this.checkMail.bind(this)} autocomplete="off" name="email" />
                                            <span className="default" id="emailErr"></span>
                                        </div>
                                        <div className="group">
                                            <input type="button" className="button" id="button_su" value="注册" style={{ cursor: "pointer" }}  onClick={this.signup.bind(this)} />
                                        </div>
                                        <div className="hr"></div>
                                        <div className="foot-lnk">
    ...
    signup() {
        /*
            暂时用于页面转跳,交互完成后记到把下面的代码加入逻辑判断中
            由于现在没有后端交互，所以默认点击注册即转跳
            注册即登录，无需注册后再次输入账号密码进行登录
        */
